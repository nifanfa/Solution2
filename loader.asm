...
multiboot_entry:
        ...
        mov eax,[eax]
        add eax,EXE
        lea eax,[eax+NTHeader.ImageBase]
        mov eax,[eax]
        push eax
        ...
        mov eax,[eax]
        add eax,EXE
        lea eax,[eax+NTHeader.NumberOfSections]
        mov eax,[eax]
        and eax,0xFFFF
        mov edx,eax
        ...
        mov eax,[eax]
        add eax,EXE
        add eax,NTHeader_size

        mov ebx,0
loop:
        lea edi,[eax+SectionHeader.VirtualAddress]
        lea esi,[eax+SectionHeader.PointerToRawData]
        lea ecx,[eax+SectionHeader.SizeOfRawData]
        mov edi,[edi]
        mov esi,[esi]
        mov ecx,[ecx]
        add edi,[esp+0]
...
struc NTHeader
        ...
        .SizeOfStackReserve: resb 4
        .SizeOfStackCommit: resb 4
        .SizeOfHeapReserve: resb 4
        .SizeOfHeapCommit: resb 4
        .LoaderFlags: resb 4
